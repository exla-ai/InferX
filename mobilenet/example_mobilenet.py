...
from exla.models.data_loader import data_loader

def main():
    # Initialize data loader with a path to your dataset
    train_data = data_loader(path="sample_data/train")
